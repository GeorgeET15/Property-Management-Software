...
<div class="horizontal-scroll-section mb-4 pb-2">
    <!-- Stat Cards -->
    <div class="card border-0 shadow-sm overflow-hidden" style="background: var(--blue-gradient);">
    ...
    <div class="card border-0 shadow-sm overflow-hidden" style="background: var(--yellow-gradient);">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div class="rounded-circle bg-white p-3 shadow-sm">
            ...
            <p class="text-muted small mb-0">Active Tenants</p>
        </div>
    </div>
    ...
    <div class="card border-0 shadow-sm bg-dark text-white">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div class="p-2 bg-secondary rounded text-white">
                    <i class="bi bi-cash fs-5"></i>
                </div>
            </div>
            <h3 class="fw-bold mb-1">$<?= number_format($total_revenue, 2) ?></h3>
            <p class="text-white-50 small mb-0">Total Revenue</p>
        </div>
    </div>
</div>
